    ...
    private:
        ...
        public:
            ...
            StreamOperation(StreamHw::StreamOp_t operation,
                ...
                : m_operation(operation), m_fifos(fifos), m_inputFifosIDs(inputFifosIDs), m_outputFifosIDs(outputFifosIDs)
            {
                switch (operation)
                {
            ...
            StreamOperation(StreamHw::StreamOp_t operation, std::vector<std::queue<float>> &fifos,
                            ...
                            std::vector<uint32_t> outputFifosIDs)
                : m_operation(operation), m_fifos(fifos), m_inputFifosIDs(inputFifosIDs), m_outputFifosIDs(outputFifosIDs), m_scalarOperand(scalarOperand)
            {
                switch (operation)
                {
